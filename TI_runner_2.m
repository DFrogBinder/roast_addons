...
for i = 1:numSubj
    ...
    if exist(marker_r,'file') && exist(marker_l,'file') && ~exist(marker_TI,'file')
        ...
        %% Node distance histogram plots
        plot_node_distance_histogram(...
                                    grayNode1, ...
                                    'Histogram of Node-to-Node Distances (grayNode1)');
        plot_node_distance_histogram(...
                                    grayNode2,... 
                                   'Histogram of Node-to-Node Distances (grayNode2)');
        plot_nearest_node_distance_histogram( ...
                                    grayNode1, grayNode2, ...
                                    'grayNode1→grayNode2 Nearest‐Neighbor Distances',...
                                    numBins=100);
